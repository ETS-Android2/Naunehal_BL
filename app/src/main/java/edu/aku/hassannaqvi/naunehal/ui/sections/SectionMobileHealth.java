...
public class SectionMobileHealth extends AppCompatActivity implements EndSectionActivity {
    ...
    private void saveDraft() {
        ...
        mobileHealth.setMh011(bi.mh011.getText().toString());

        mobileHealth.setMh012(bi.mh012.getText().toString());

        mobileHealth.setMh013(bi.mh013.getText().toString());

        mobileHealth.setMh014(bi.mh014.getText().toString());
        ...
        mobileHealth.setMh019077x(bi.mh019077x.getText().toString());
